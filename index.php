                        ...
                        <div class="row align-items__center">
                            ...
                            <div class="col-lg-6 col-sm-5 col-xs-12 col-md-5">
                                <div class="slide__thumb">
                                    <img src="images/slider/fornt-img/banner2.png" alt="slider images">
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="single__slide animation__style01 slider__fixed--height">
                    <div class="container">
                        <div class="row align-items__center">
                            ...
                            <div class="col-lg-6 col-sm-5 col-xs-12 col-md-5">
                                <div class="slide__thumb">
                                    <img src="images/slider/fornt-img/banner3.jpg" alt="slider images">
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row">
                    <div class="col-xs-12">
                        <div class="section__title--2 text-center">
                            <h2 class="title__line">Latest product</h2>
                    ...
                    <div class="row">
                        <div class="product__list clearfix mt--30">
                            <?php 
                             ...
                             $get_product=get_product($con,11,'','');
                                ...
                                <div class="category">
                                    <div class="ht__cat__thumb">
                                        <a href="product.php?id=<?php echo $list['id']?>">
                                            <img src="<?php echo PRODUCT_IMAGE_SITE_PATH.$list['image']?>" alt="product images" width="95px" height="210px">
                                        </a>
                                    </div>
